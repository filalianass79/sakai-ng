...
@Component({
    ...
    imports: [RouterModule, StyleClassModule, ButtonModule, RippleModule, SelectButtonModule],
    template: `<a class="flex items-center" href="#">
        ...
        <div class="items-center bg-surface-0 dark:bg-surface-900 grow justify-between hidden lg:flex absolute lg:static w-full left-0 top-full px-12 lg:px-0 z-20 rounded-border">
            <ul class="list-none p-0 m-0 flex lg:items-center select-none flex-col lg:flex-row cursor-pointer gap-20">
                <li>
                    <a (click)="router.navigate(['/landing'], { fragment: 'home' })" pRipple class="px-0 py-12 text-surface-900 dark:text-surface-0 font-medium text-xl">
                        <span>Home</span>
                    </a>
                </li>
                <li>
                    <a (click)="router.navigate(['/landing'], { fragment: 'features' })" pRipple class="px-0 py-12 text-surface-900 dark:text-surface-0 font-medium text-xl">
                        <span>Features</span>
                    </a>
                </li>
                <li>
                    <a (click)="router.navigate(['/landing'], { fragment: 'highlights' })" pRipple class="px-0 py-12 text-surface-900 dark:text-surface-0 font-medium text-xl">
                        <span>Highlights</span>
                    </a>
                </li>
                <li>
                    <a (click)="router.navigate(['/landing'], { fragment: 'pricing' })" pRipple class="px-0 py-12 text-surface-900 dark:text-surface-0 font-medium text-xl">
                        <span>Pricing</span>
                    </a>
                </li>
            </ul>
            <div class="flex border-t lg:border-t-0 border-surface py-12 lg:py-0 mt-12 lg:mt-0 gap-2">
            <p-selectbutton [options]="justifyOptions"  optionLabel="justify">
...
export class TopbarWidget {
    justifyOptions = [
        { label: 'French', icon: 'pi pi-fw pi-flag' },
        { label: 'English', icon: 'pi pi-fw pi-flag' },
        { label: 'Arabic', icon: 'pi pi-fw pi-flag' }
    ];
    value: any;
