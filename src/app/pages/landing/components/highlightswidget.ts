...
@Component({
    ...
    template: `
        <div id="highlights" class="py-12 px-12 lg:px-20 mx-0 my-12 lg:mx-20">
            ...
            <div class="grid grid-cols-12 gap-4 grid-cols-12 gap-6 grid-cols-12 gap-12 grid-cols-12 gap-12 mt-20 pb-2 md:pb-20">
            ...
            <div class="grid grid-cols-12 gap-4 grid-cols-12 gap-6 grid-cols-12 gap-12 grid-cols-12 gap-12 my-20 pt-2 md:pt-20">
