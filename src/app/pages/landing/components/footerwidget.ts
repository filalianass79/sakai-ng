...
@Component({
    ...
    template: `
        <div class="py-12 px-12 mx-0 mt-20 lg:mx-20">
            <div class="grid grid-cols-12 gap-4 grid-cols-12 gap-6 grid-cols-12 gap-12 grid-cols-12 gap-12">
                ...
                <div class="col-span-12 md:col-span-10">
                    <div class="grid grid-cols-12 gap-4 grid-cols-12 gap-6 grid-cols-12 gap-12 grid-cols-12 gap-20 text-center md:text-left">
