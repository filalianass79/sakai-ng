        ...
        <div style="border-radius: 56px; padding: 0.3rem; background: linear-gradient(180deg, var(--primary-color) 10%, rgba(33, 150, 243, 0) 30%)">
          <div class="w-full bg-surface-0 dark:bg-surface-900 py-20 px-20 sm:px-20" style="border-radius: 53px">
            <div class="text-center mb-20">
              ...
              <div class="text-surface-900 dark:text-surface-0 text-3xl font-medium mb-12">Créer un compte</div>
            ...
            <form [formGroup]="registerForm" (ngSubmit)="onSubmit()" class="p-fluid">
              <div class="grid grid-cols-12 gap-4 grid-cols-12 gap-6 grid-cols-12 gap-12">
                <div class="col-span-12 gap-12 mt-12">
                ...
                <div class="col-span-12 gap-12 mt-12">
                  <label for="roles" class="block text-surface-900 dark:text-surface-0 text-xl font-medium mb-2">Rôles</label>
                  <p-multiSelect
                    id="roles"
                    [options]="roles"
                  ...
                  ></p-multiSelect>
                  <small class="p-error block" *ngIf="isFieldInvalid('roles')">
                ...
                <div class="col-span-12 gap-12 mt-12">
                  <div class="flex gap-12">
                    <div class="flex-1">
                        <label for="password" class="block text-surface-900 dark:text-surface-0 text-xl font-medium mb-2">Mot de passe</label>
                        <p-password
                          class="w-full md:w-[30rem] "
                          styleClass="mb-12" [fluid]="true" 
                          id="password"
                    ...
                    <div class="flex-1">
                        <label for="confirmPassword" class="block text-surface-900 dark:text-surface-0 text-xl font-medium mb-2">Confirmer</label>
                        <p-password
                          id="confirmPassword"
                          class="w-full md:w-[30rem] "
                          styleClass="mb-12" [fluid]="true"
                ...
                <div class="col-span-12 text-center mt-20">
                  <span class="text-muted-color font-medium">Déjà inscrit?</span>
                  <a class="font-medium no-underline ml-2" style="color: var(--primary-color)" routerLink="/auth/login">
                    Se connecter
                  </a>
                </div>
              </div>
...
export class Register implements OnInit {
  ...
  roles: Role[] = [
    ...
    { name: 'Modérateur', code: 'MODERATOR' }
  ];
  ...
  isFieldInvalid(fieldName: string): boolean {
    ...
    if (fieldName === 'confirmPassword') {
      return (field.invalid || this.registerForm.hasError('mismatch')) && field.touched;
    }
